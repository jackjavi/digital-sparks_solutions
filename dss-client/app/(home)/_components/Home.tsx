    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto  px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="max-w-5xl mx-auto pb-12">
          <div
            className={`inline-flex gap-2 mx-4 sm:mx-8 px-2 md:px-4 py-2 md:py-2 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl shadow-lg transition-all duration-1000 ${
              isVisible
        ...
        <div className=" max-w-5xl mx-auto sm:flex sm:flex-col sm:items-center sm:justify-center space-y-8 sm:space-y-12">
          ...
          >
            <div className="inline-block sm:w-[50vw] mx-4 bg-white dark:bg-slate-900 backdrop-blur-xl  shadow-2xl px-2 py-2">
              <h1 className="text-start text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-slate-900 dark:text-white leading-tight font-lilita-one">
          ...
          >
            <div className="inline-block sm:w-[50vw] mx-4 bg-white  dark:bg-slate-900  backdrop-blur-xl  shadow-xl px-2 py-2">
              <p className="text-start text-lg sm:text-xl lg:text-2xl text-slate-700 dark:text-gray-300 leading-relaxed font-nunito">
          ...
          {/* CTA Buttons */}
          <div
            className={`flex flex-col md:flex-row gap-4 md:gap-20 sm:w-[50vw] mx-4 tracking-tighter text-sm font-light uppercase justify-start items-center pt-4 transition-all duration-1000 delay-600 ${
              isVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 -translate-y-4"
            }`}
          ...
          >
            <div className="hidden md:inline-block sm:w-[50vw] mx-4 bg-white/75 dark:bg-slate-900/75 backdrop-blur-xl shadow-lg px-2 py-2 border-t-2 border-slate-200/75 dark:border-slate-700/75">
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-20 justify-start items-center flex-wrap">
